  ...
  <div class="container">
    <!--<form class="login-form" name="login" id="login" action="create_docket.php">-->
      ...
      <div class="login-wrap">
        ...
        <button class="btn btn-primary btn-lg btn-block" type="submit" id="enviar" id="enviar">Login</button>
        <button class="btn btn-info btn-lg btn-block" type="reset">Clean</button>
      </div>
    </form>
  </div>
</body>
